...
/* package mathematic-0.1.0.0 */
#ifndef VERSION_mathematic
#define VERSION_mathematic "0.1.0.0"
#endif /* VERSION_mathematic */
#ifndef MIN_VERSION_mathematic
#define MIN_VERSION_mathematic(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mathematic */
...
#define CURRENT_COMPONENT_ID "mathematic-0.1.0.0-2RGCnPuM90uDc3cvTDcosc-mathematic"
